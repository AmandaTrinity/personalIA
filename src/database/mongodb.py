...
is_uvicorn_worker = not is_main_process or os.getpid() != os.getppid()
...
if not uri and not is_testing:
    raise ValueError("❌ MONGO_URI não configurada no arquivo .env! Por favor, configure a variável de ambiente.")
