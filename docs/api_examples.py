#!/usr/bin/env python3
"""
Exemplos corretos para testar a API PersonalIA
"""

print("🧪 Comandos corretos para testar a API PersonalIA")
print("=" * 50)
...
print("\n2️⃣ POST - Criar novo treino (FORMATO CORRETO):")
test_id = test_ids[0]
...
print("\n✅ IMPORTANTE:")
print("   - 'equipamentos' deve ser ARRAY (ex: ['halteres', 'esteira']) ✅")
print("   - Pode ser lista vazia: [] para treino só com peso corporal")
